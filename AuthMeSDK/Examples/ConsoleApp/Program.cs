    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            if (!config.IsValid())
            {
                ...
                System.Console.WriteLine("• (app id) → Your actual App ID");
                ...
                System.Console.WriteLine("1. Go to your AuthMe dashboard (usually https://authme.space/dashboard)");
                System.Console.WriteLine("2. Select your application");
                System.Console.WriteLine("3. Navigate to the 'Credentials' tab");
                System.Console.WriteLine("4. Copy your Owner ID and App Secret");
                System.Console.WriteLine("");
